...
<body>
<header>
<x-markdown src="mavenSection/00_header.md" />
</header>
<nav>
<div class="menubar">
<a class="button">&#9776;&nbsp;索引</a>
...
<article>
<x-markdown src="mavenSection/01_maven安装.md" />
<x-markdown src="mavenSection/02_maven命令.md" />
<x-markdown src="mavenSection/03_maven插件.md" />
</article>
<footer>
<x-markdown src="mavenSection/99_footer.md" />
</footer>
</body>
</html>