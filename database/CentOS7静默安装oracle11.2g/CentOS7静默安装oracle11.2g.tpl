...
<title>CentOS7静默安装oracle11.2g</title>
<style>
/* RESET
=============================================================================*/
...
<article>
<x-markdown src="section/01_前期工作.md" />
<x-markdown src="section/02_配置oracle环境.md" />
<x-markdown src="section/03_安装oracle.md" />
<x-markdown src="section/04_安装监听与创建数据库与实例.md" />
<x-markdown src="section/05_启动与服务.md" />
</article>
<footer>
