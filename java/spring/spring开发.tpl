...
<body>
<header>
<x-markdown src="springSection/00_header.md" />
</header>
<nav>
<div class="menubar">
<a class="button">&#9776;&nbsp;索引</a>
...
<article>
<x-markdown src="springSection/01_spring基本配置.md" />
<x-markdown src="springSection/02_springMVC配置.md" />
</article>
<footer>
<x-markdown src="springSection/99_footer.md" />
</footer>
</body>
</html>